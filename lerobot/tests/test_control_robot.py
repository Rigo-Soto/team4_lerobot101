...
from lerobot.src.lerobot.scripts.lerobot_calibrate import CalibrateConfig, calibrate
from lerobot.src.lerobot.scripts.lerobot_record import RecordConfig, record
from lerobot.src.lerobot.scripts.lerobot_replay import DatasetReplayConfig, ReplayConfig, replay
from lerobot.src.lerobot.scripts.lerobot_teleoperate import TeleoperateConfig, teleoperate
from lerobot.tests.fixtures.constants import DUMMY_REPO_ID
from lerobot.tests.mocks.mock_robot import MockRobotConfig
from lerobot.tests.mocks.mock_teleop import MockTeleopConfig
