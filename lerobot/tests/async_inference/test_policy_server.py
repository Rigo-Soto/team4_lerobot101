...
from lerobot.src.lerobot.configs.types import PolicyFeature
...
def policy_server():
    ...
    from lerobot.src.lerobot.async_inference.configs import PolicyServerConfig
...
def _make_obs(state: torch.Tensor, timestep: int = 0, must_go: bool = False):
    ...
    from lerobot.src.lerobot.async_inference.helpers import TimedObservation
