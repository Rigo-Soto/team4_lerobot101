...
def test_async_inference_e2e(monkeypatch):
    ...
    from lerobot.src.lerobot.async_inference.configs import PolicyServerConfig, RobotClientConfig
    from lerobot.src.lerobot.async_inference.helpers import map_robot_keys_to_lerobot_features
    from lerobot.src.lerobot.async_inference.policy_server import PolicyServer
    from lerobot.src.lerobot.async_inference.robot_client import RobotClient
    from lerobot.src.lerobot.robots.utils import make_robot_from_config
