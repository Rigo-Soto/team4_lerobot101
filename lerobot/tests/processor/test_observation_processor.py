...
from lerobot.src.lerobot.configs.types import FeatureType, PipelineFeatureType
from lerobot.src.lerobot.processor import VanillaObservationProcessorStep
from lerobot.src.lerobot.processor.converters import create_transition
from lerobot.src.lerobot.types import TransitionKey
from lerobot.src.lerobot.utils.constants import OBS_ENV_STATE, OBS_IMAGE, OBS_IMAGES, OBS_STATE
from lerobot.tests.conftest import assert_contract_is_typed
...
def test_equivalent_to_original_function():
    ...
    from lerobot.src.lerobot.envs.utils import preprocess_observation
