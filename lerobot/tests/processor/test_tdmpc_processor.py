...
from lerobot.src.lerobot.policies.tdmpc.configuration_tdmpc import TDMPCConfig
from lerobot.src.lerobot.policies.tdmpc.processor_tdmpc import make_tdmpc_pre_post_processors
