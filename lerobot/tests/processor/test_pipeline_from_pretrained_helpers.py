...
from lerobot.src.lerobot.processor.pipeline import DataProcessorPipeline, ProcessorMigrationError
...
def test_resolve_step_class_registry_name():
    ...
    from lerobot.src.lerobot.processor.pipeline import ProcessorStep, ProcessorStepRegistry
...
def test_resolve_step_class_import_path():
    ...
    from lerobot.src.lerobot.processor.pipeline import ProcessorStep
