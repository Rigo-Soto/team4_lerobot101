...
from lerobot.src.lerobot.processor import DataProcessorPipeline, DeviceProcessorStep
...
def test_integration_with_robot_processor():
    ...
    from lerobot.src.lerobot.processor import AddBatchDimensionProcessorStep
