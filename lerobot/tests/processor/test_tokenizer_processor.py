...
from lerobot.src.lerobot.processor import DataProcessorPipeline, TokenizerProcessorStep
...
def test_registry_functionality():
    ...
    from lerobot.src.lerobot.processor import ProcessorStepRegistry
...
def test_integration_with_device_processor(mock_auto_tokenizer):
    ...
    from lerobot.src.lerobot.processor import DeviceProcessorStep
