...
from lerobot.src.lerobot.envs.configs import EnvConfig
from lerobot.src.lerobot.envs.factory import make_env, make_env_config, make_env_pre_post_processors
...
def test_custom_get_env_processors_override():
    ...
    from lerobot.src.lerobot.processor.pipeline import DataProcessorPipeline
