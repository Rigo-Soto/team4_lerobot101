...
from lerobot.src.lerobot.motors.dynamixel import MODEL_NUMBER_TABLE, DynamixelMotorsBus
from lerobot.src.lerobot.motors.dynamixel.tables import X_SERIES_CONTROL_TABLE
from lerobot.src.lerobot.motors.encoding_utils import encode_twos_complement

try:
    import dynamixel_sdk as dxl

    from lerobot.tests.mocks.mock_dynamixel import MockMotors, MockPortHandler
