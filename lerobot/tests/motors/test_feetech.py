...
from lerobot.src.lerobot.motors.encoding_utils import encode_sign_magnitude
from lerobot.src.lerobot.motors.feetech import MODEL_NUMBER, MODEL_NUMBER_TABLE, FeetechMotorsBus
from lerobot.src.lerobot.motors.feetech.tables import STS_SMS_SERIES_CONTROL_TABLE

try:
    import scservo_sdk as scs

    from lerobot.tests.mocks.mock_feetech import MockMotors, MockPortHandler
