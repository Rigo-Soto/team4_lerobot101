...
from lerobot.src.lerobot.robots.unitree_g1.g1_utils import REMOTE_AXES
from lerobot.src.lerobot.teleoperators.unitree_g1.config_unitree_g1 import (
    ExoskeletonArmPortConfig,
    UnitreeG1TeleoperatorConfig,
)
from lerobot.src.lerobot.teleoperators.unitree_g1.unitree_g1 import RemoteController, UnitreeG1Teleoperator
...
class TestExoskeletonArm:
    def test_parse_raw16_valid(self):
        from lerobot.src.lerobot.teleoperators.unitree_g1.exo_serial import parse_raw16
    ...
    def test_calibrate_requires_connection(self):
        from lerobot.src.lerobot.teleoperators.unitree_g1.exo_serial import ExoskeletonArm
