...
from lerobot.src.lerobot.datasets.dataset_tools import (
    add_features,
...
from lerobot.tests.datasets.test_video_encoding import _add_frames, require_h264, require_libsvtav1
