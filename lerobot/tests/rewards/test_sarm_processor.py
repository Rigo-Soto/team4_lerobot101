...
class TestSARMEncodingProcessorStepEndToEnd:
    ...
    def processor_with_mocks(self, mock_clip_model):
        ...
        from lerobot.src.lerobot.rewards.sarm.processor_sarm import SARMEncodingProcessorStep
    ...
    def test_full_sequence_target_consistency(self, mock_clip_model):
        ...
        from lerobot.src.lerobot.rewards.sarm.processor_sarm import SARMEncodingProcessorStep
        from lerobot.src.lerobot.rewards.sarm.sarm_utils import find_stage_and_tau
