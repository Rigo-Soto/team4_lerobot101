...
from lerobot.src.lerobot.rewards.pretrained import PreTrainedRewardModel
...
def test_reward_model_config_lookup():
    ...
    from lerobot.src.lerobot.rewards.classifier.configuration_classifier import RewardClassifierConfig
...
def test_factory_get_reward_model_class():
    ...
    from lerobot.src.lerobot.rewards.factory import get_reward_model_class

    cls = get_reward_model_class("sarm")
    from lerobot.src.lerobot.rewards.sarm.modeling_sarm import SARMRewardModel
...
def test_train_pipeline_config_trainable_config_returns_policy_when_set():
    ...
    from lerobot.src.lerobot.configs.default import DatasetConfig
    from lerobot.src.lerobot.configs.train import TrainPipelineConfig
    from lerobot.src.lerobot.policies.diffusion.configuration_diffusion import DiffusionConfig
...
def test_train_pipeline_config_from_pretrained_migrates_legacy_rabc_fields(tmp_path):
    ...
    from lerobot.src.lerobot.configs.default import DatasetConfig
    from lerobot.src.lerobot.configs.train import TRAIN_CONFIG_NAME, TrainPipelineConfig
    from lerobot.src.lerobot.policies.diffusion.configuration_diffusion import DiffusionConfig
...
def test_reward_model_push_model_to_hub_uploads_expected_files(monkeypatch, _offline_model_card):
    ...
    from lerobot.src.lerobot.rewards import pretrained as reward_pretrained
