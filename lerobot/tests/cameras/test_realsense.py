...
from lerobot.src.lerobot.cameras.configs import Cv2Rotation
from lerobot.src.lerobot.utils.errors import DeviceAlreadyConnectedError, DeviceNotConnectedError

pytest.importorskip("pyrealsense2")

from lerobot.src.lerobot.cameras.realsense import RealSenseCamera, RealSenseCameraConfig
