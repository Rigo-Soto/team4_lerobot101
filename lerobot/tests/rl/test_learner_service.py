...
from lerobot.tests.utils import skip_if_package_missing  # our gRPC servicer class
...
def create_learner_service_stub(
    ...
    from lerobot.src.lerobot.rl.learner_service import LearnerService
    from lerobot.src.lerobot.transport import services_pb2_grpc  # generated from .proto
