...
from lerobot.src.lerobot.robots.unitree_g1.config_unitree_g1 import UnitreeG1Config
from lerobot.src.lerobot.robots.unitree_g1.g1_utils import (
    NUM_MOTORS,
    REMOTE_AXES,
    REMOTE_BUTTONS,
    REMOTE_KEYS,
...
def unitree_g1():
    ...
    with (
        ...
        from lerobot.src.lerobot.robots.unitree_g1.unitree_g1 import UnitreeG1
