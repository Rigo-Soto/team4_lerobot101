...
from lerobot.src.lerobot.robots.bi_rebot_b601_follower import BiRebotB601Follower, BiRebotB601FollowerConfig
from lerobot.src.lerobot.robots.rebot_b601_follower import (
    RebotB601Follower,
